    ...
    <div class="modal-dialog">
        <div class="modal-content">
            <div class="modal-header">
                <h5 class="modal-title" id="verifModalLabel">Verifikasi Tahap I</h5>
                <button type="button" class="btn-close" data-bs-dismiss="modal" aria-label="Close"></button>
            </div>
            <div class="modal-body">
                <form action="<?= base_url('admin/verif1'); ?>" method="post">
                    <?= csrf_field(); ?>
                    <input type="hidden" name="id" id="id">
                    <div class="form-check">
                        <label class="form-check"><strong>Verifikasi</strong></label>
                        <input class="form-check-input" type="radio" name="status" id="lanjut2" value="lanjut2">Lanjutkan ke Tahap II<br>
                    ...
                    <br>
                    <div class="form-check">
                        <label class="form-check"><strong>Langkah Tindak Lanjut</strong></label>
                        <input class="form-check-input" type="radio" name="langkah" id="rekomendasi" value="rekomendasi">Rekomendasi<br>
                        <input class="form-check-input" type="radio" name="langkah" id="pulbaket" value="pulbaket">Pulbaket<br>
                    </div>
                    <div class="form-floating">
                        <input class="form-control" type="text" id="ket" name="ket" style="height: 100px">
