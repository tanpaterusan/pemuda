    ...
    <div class="modal-dialog">
        <div class="modal-content">
            <div class="modal-header">
                <h5 class="modal-title" id="verifModalLabel">Verifikasi Tahap II</h5>
                <button type="button" class="btn-close" data-bs-dismiss="modal" aria-label="Close"></button>
            </div>
            <div class="modal-body">
                <form action="<?= base_url('admin/verif2'); ?>" method="post">
                    <input type="hidden" name="id" id="id">
                    <div class="form-check">
                        <label class="form-check"><strong>Verifikasi</strong></label>
                        <input class="form-check-input" type="radio" name="status" id="lanjut3" value="lanjut3">Lanjutkan ke Tahap III<br>
                    ...
                    <div class="form-check">
                        ...
                        <input class="form-check-input" type="radio" name="langkah" id="pemeriksaan" value="pemeriksaan">Pemeriksaan<br>
                    </div>
                    <div class="form-floating">
                        <input class="form-control" id="ket" name="ket" style="height: 100px">
