        ...
        <div class="modal-content">
            ...
            <div class="modal-body">
                <form action="<?= base_url('admin/tambahFormat'); ?>" method="post">
                    <div class="row mb-3">
                        <label for="title" class="col-sm-2 col-form-label">Head</label>
                        <div class="col-sm-10">
                            <select class="form-select" aria-label="Default select example" name="head">
                                <option value="">--pilih format--</option>
                                <option value="pulbaket" id="pulbaket">Pulbaket</option>
                                <option value="pemeriksaan" id="pemeriksaan">Pemeriksaan</option>
                            </select>
                        </div>
                    </div>
                    <div class="row mb-3">
